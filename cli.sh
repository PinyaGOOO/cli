...
nmcli con modify Проводное\ подключение\ 1 ipv4.gateway 4.4.4.1 ipv4.dns 172.16.100.2 ipv4.dns-search hq.work ipv4.routes 172.16.100.2/26 4.4.4.1 +ipv4.routes 192.168.100.0/26 4.4.4.1
